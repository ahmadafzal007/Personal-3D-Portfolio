...
let projects = [
  {
    ...
    url: 'http://nawalah.com/',
  },
  {
    image: 'textures/project8.png',
    url: 'https://github.com/ahmadafzal007/MedTalk-React-app.git',
  },
  {
  ...
  },
  {
    ...
    url: 'https://github.com/ahmadafzal007/ACL-Ligament-Tear-Assessment-Model.git',
  },
  {
    image: 'textures/project1.png',
    url: 'http://nawalah.com/',
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('Ahmed Afzal', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
  ...
  loader.load('fonts/helvatica.json', function (font) {
    ...
    const subTitleGeo = new TextGeometry(
      'Web Developer / ML Enthusiast / Cloud Engineer',
      {
        font: font,
        size: 0.018,
        height: 0,
